        ...
        <div className="p-6 flex justify-between items-start">
            <div>
                ...
                <div className="mt-4 flex items-center gap-3">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm">{shippingMethod.name} estimated date of arrival <strong className='text-white'>{shippingMethod.eta}</strong></p>
                </div>
            </div>
            <button
...
// ---------------------------------------------------------------------------
// --- Main Page Component ---
const OrderReviewPage = ({ totalSummery, setSelectedScreen, buttonOptions }) => {
    return (
