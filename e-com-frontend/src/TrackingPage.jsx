        ...
        <div className="flex flex-col gap-4 p-4 bg-white dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800 h-full">
            ...
            <div className="flex flex-col gap-2">
                {orders.map(order => {
                    ...
                    const selectedStyle = (order.id === selectedItem.id) ? 'bg-primary/10 dark:bg-primary/20 border border-primary/50' : 'hover:bg-gray-100 dark:hover:bg-gray-800/50';
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-xs">{order.status === 'Delivered' ? `Delivered: ${order.ata}` : `Est. Delivery: ${order.eta}`}</p>
                            </div>
                        </div>
                    );
                })}
...
const MainTrackingContent = ({ selectedOrder, congineeDetail }) => (
    <div className="flex-1 flex flex-col gap-8">
        ...
        <div className="bg-white dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
            <div className="flex flex-col sm:flex-row items-stretch justify-between gap-6">
                <div className="flex flex-col gap-2 flex-[2_2_0px]">
                    <p className="text-primary text-sm font-semibold">Estimated Delivery: {selectedOrder.eta}</p>
                    <a
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Order Date: {selectedOrder.orderDate}</p>
        ...
        <TrackingDetails orderId={selectedOrder.id} congineeDetail={congineeDetail} />
